...
# Backward-compatibility constants (used by legacy adapters)
NEO4J_URI = EnvConfig.get_neo4j_uri()
NEO4J_USER = EnvConfig.get_neo4j_user()
NEO4J_PASSWORD = EnvConfig.get_neo4j_password()